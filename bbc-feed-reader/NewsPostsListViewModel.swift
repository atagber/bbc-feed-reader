...
public class NewsPostsListViewModel: NewsPostsListViewModelType, NewsPostsListViewModelInputs,
  NewsPostsListViewModelOutputs {
  ...
  public var inputs: NewsPostsListViewModelInputs {
    return self
  }
  public var outputs: NewsPostsListViewModelOutputs {
    return self
  }
}

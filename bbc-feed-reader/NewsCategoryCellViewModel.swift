...
public class NewsCategoryCellViewModel: NewsCategoryCellViewModelType, NewsCategoryCellViewModelInputs, NewsCategoryCellViewModelOutputs {
  
  init() {
    self.nameLabelText = self.newsCategoryProperty.signal.skipNil().map { $0.name }
    self.selectionIndicatorHidden = self.isSelectedProperty.signal.skipNil().map { !$0 }
  }
  ...
  public var inputs: NewsCategoryCellViewModelInputs { return self }
  public var outputs: NewsCategoryCellViewModelOutputs { return self }
}
